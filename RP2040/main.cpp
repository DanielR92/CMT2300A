...
void build() {
    ...
    if(crc == recCrc) {
        if(HMS500 == wrType) {
            ...
            printVal(payload, 56, 2,   10, "CH0 - Q  ", "var", false);
            printVal(payload, 58, 2,  100, "CH0 - I  ", "A");
            printVal(payload, 60, 2, 1000, "CH0 - PF ", "");
            printVal(payload, 62, 2,   10, "CH0 - T  ", "°C", false);
            ...
            printVal(payload, 84, 2,   10, "CH0   - Q    ", "var", false);
            printVal(payload, 86, 2,  100, "CH0   - I1   ", "A");
            printVal(payload, 88, 2,  100, "CH0   - I2   ", "A");
            printVal(payload, 90, 2,  100, "CH0   - I3   ", "A");
            printVal(payload, 92, 2, 1000, "CH0   - PF   ", "");
            printVal(payload, 94, 2,   10, "CH0   - T    ", "°C", false);
